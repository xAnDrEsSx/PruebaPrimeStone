        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_Students_IdStudent",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdStudent = table.Column<int>(type: "int", nullable: false),
                    Registration_Date = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enroll_Courses_IdCourse",
                        column: x => x.IdCourse,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_IdStudent",
                table: "Address",
                column: "IdStudent");

            migrationBuilder.CreateIndex(
                name: "IX_Enroll_IdCourse",
                table: "Enroll",
                column: "IdCourse");
        }
